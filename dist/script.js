...
/* harmony import */ var _checkNum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNum */ "./src/js/modules/checkNum.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');

  function bindActionTwoElems(event, elem, prop) {
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        switch (item.nodeName) {
          //проверяем какой тип элемента
          case 'SPAN':
            state[prop] = i; //console.log('span');
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              state[prop] = item.value; //console.log('input');
            }

            break;

          case 'SELECT':
            state[prop] = item.value; //console.log('select');
...
/* harmony import */ var _checkNum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNum */ "./src/js/modules/checkNum.js");
...
var forms = function forms(state) {
  ...
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка',
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    //i = 0 что начальный таб показывался первый
